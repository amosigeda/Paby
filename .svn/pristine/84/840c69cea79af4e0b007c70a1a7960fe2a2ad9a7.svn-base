...
package com.wtwd.common.bean.adragon.other;

public class AdragonDeviceActiveInfo {
	
	private String cmd;
	private String serie_no;
	private String device_product_model;
	private String device_firmware_edition;
