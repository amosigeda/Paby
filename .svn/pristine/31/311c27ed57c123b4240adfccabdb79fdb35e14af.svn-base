...
<jsp:useBean id="LOGINUSER" class="com.wtwd.app.LoginUser"
...
function exit(){
  ...
  <!-- ;CheckShowLeft() -->
	<body leftMargin=0 topMargin=0 marginwidth="0" marginheight="0"
	 ...
	 <div id="top">
  <div class="top_user">
        <span class="smalltext"> 当前用户-<strong><%=LOGINUSER.getUserName()%></strong>-版本(V0.4)-<a href='javascript:exit()' id="a_test">退出</a></span>
