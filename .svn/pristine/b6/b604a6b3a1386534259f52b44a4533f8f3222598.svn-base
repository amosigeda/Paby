...
function onView(download){
	...
	frmGo.action="doWappUsers.do?method=downloadApk&download="+download;
   	frmGo.submit();
}
</script>
	<body>
		<span class="title_1"></span>
		<form name="frmGo" method="post" action="doWappUsers.do?method=queryWappUsers">			
					...
					<tr class="tr_5" onmouseover='this.className="tr_4"' onmouseout='this.className="tr_5"' >
						...
						<td>
							...
							<logic:notEmpty name="element" property="photo">
								<a href=# onclick="onView('<bean:write name="element" property="photo"/>')" style="color:#0000FF">下载</a>
							</logic:notEmpty>							
						</td>						
