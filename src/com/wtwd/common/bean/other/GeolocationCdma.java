...
public class GeolocationCdma {
	...
	public List<CellTowerCdma> getCellTowers() {
		return cellTowers;
	}
	public void setCellTowers(List<CellTowerCdma> cellTowers) {
