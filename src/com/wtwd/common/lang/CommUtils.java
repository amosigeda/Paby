...
import com.wtwd.common.config.Config.SystemConfig;
...
//			p.print("m.add(0,-1,'"+name+"');\r\t"); // 创建根 " + name + "
			...
			p.print(dt.toString());
			System.out.print(dt.toString());		//yonghu debug
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
...
//		}else if(2 == isSelect){
//			sf.append("\t\t\t<option value='all'>all</option>\n");
//		}else if(3 == isSelect){
//			sf.append("\t\t\t<option value='admin'>管理员</option>\n");
//		}
