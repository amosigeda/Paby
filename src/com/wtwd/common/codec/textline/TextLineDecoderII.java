 ...
 */
public class TextLineDecoderII implements ProtocolDecoder {
    ...
    private int maxLineLength = Integer.MAX_VALUE;   //1024;
     ...
     */
    public TextLineDecoderII() {
        this(LineDelimiterII.AUTO);
    }
     ...
     */
    public TextLineDecoderII(String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public TextLineDecoderII(LineDelimiterII delimiter) {
     ...
     */
    public TextLineDecoderII(Charset charset) {
        this(charset, LineDelimiterII.AUTO);
    }
     ...
     * @param delimiter The line delimiter to use
     */
    public TextLineDecoderII(Charset charset, String delimiter) {
     ...
     * @param delimiter The line delimiter to use
     */
    public TextLineDecoderII(Charset charset, LineDelimiterII delimiter) {
        if (charset == null) {
