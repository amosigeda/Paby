 ...
 */
public class TextLineCodecFactoryII implements ProtocolCodecFactory {

    private final TextLineEncoderII encoder;

    private final TextLineDecoderII decoder;

    /**
     * Creates a new instance with the current default {@link Charset}.
     */
    public TextLineCodecFactoryII() {
     ...
     */
    public TextLineCodecFactoryII(Charset charset) {
        encoder = new TextLineEncoderII(charset, LineDelimiterII.UNIX);
        decoder = new TextLineDecoderII(charset, LineDelimiterII.AUTO);
    }
     ...
     */
    public TextLineCodecFactoryII(Charset charset, String encodingDelimiter, String decodingDelimiter) {
        encoder = new TextLineEncoderII(charset, encodingDelimiter);
        decoder = new TextLineDecoderII(charset, decodingDelimiter);
    }
     ...
     *  The line delimeter for the decoder
     */
    public TextLineCodecFactoryII(Charset charset, LineDelimiterII encodingDelimiter, LineDelimiterII decodingDelimiter) {
        encoder = new TextLineEncoderII(charset, encodingDelimiter);
        decoder = new TextLineDecoderII(charset, decodingDelimiter);
    }
