package com.wtwd.sys.deviceactiveinfo.form;
...
public class DeviceActiveInfoForm extends PublicFormBean implements Serializable{
	...
	private String listenType;   //�豸����
	
	private String target_step;   //目标步数 
    
    private String actural_step; //实际步数
    
    private String heatrate; //心率
	
	private String temperature; //体温数据
	
	private String isPhoneHelp;  //电话支持
	    
	private String isServerHelp;  //维修和服务保修情况
	    
	private Date deadline;   //到期时间״̬
	...
	public String getActural_step() {
		return actural_step;
	}

	public void setActural_step(String actural_step) {
		this.actural_step = actural_step;
	}
