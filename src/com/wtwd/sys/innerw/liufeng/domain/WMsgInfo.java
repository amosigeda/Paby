...
public class WMsgInfo extends PublicVoBean implements Serializable {

	private static final long serialVersionUID = 5649968464609256268L;
	
	private int msg_id;
	private String msg_type;
	private int msg_ind_id;
	private String msg_date;		//设备当地时间
	...
	private String msg_date_utc;		//UTC时间
	private int badge;
	private int old_badge;
	...
	/**
	 * @return the old_badge
	 */
	public int getOld_badge() {
		return old_badge;
	}

	/**
	 * @param old_badge the old_badge to set
	 */
	public void setOld_badge(int old_badge) {
		this.old_badge = old_badge;
	}

	/**
	 * @return the dest_lang
	 */
	...
	/**
	 * @param dest_lang the dest_lang to set
	 */
	public void setDest_lang(String dest_lang) {
